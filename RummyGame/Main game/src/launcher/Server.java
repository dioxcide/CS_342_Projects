...
private static final long serialVersionUID = 1L;
	...
	ConnectionThread newServer;

	// set up GUI
	public Server(GameGUI clientInstance) {	//Server Constructors creates the GUI for the server
		super("Server");
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == start && start.getText().equals("Disconnect")){
			...
			newServer = new ConnectionThread(this);
